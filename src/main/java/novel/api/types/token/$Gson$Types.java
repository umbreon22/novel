...
public final class $Gson$Types {
     ...
     * @throws IllegalArgumentException if this type is not a collection.
     */
    public static Type getElementType(Type context, Class<?> contextRawType, Class<?> classWithParam) {
        Type collectionType = getSupertype(context, contextRawType, classWithParam);
    ...
    static Type resolveTypeVariable(Type context, Class<?> contextRawType, TypeVariable<?> unknown) {
        ...
        if (declaredByRaw == null) {//we can't reduce this further
            return unknown;
        }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            for (int t = 0, length = this.typeArguments.length; t < length; t++) {
                ...
                //checkNotPrimitive(this.typeArguments[t]); ~> Gson checks this, but I think we can support primitives. todo: investigate.
